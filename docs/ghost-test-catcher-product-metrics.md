...
Generated: `2026-07-10T04:22:49+02:00`
Commit: `c3d2f5e`
...
| Built-in calibration runtime | 1.951s |
...
| --- | ---: | ---: | ---: | ---: |
| Previous full-enumeration policy | 16 | 17881 | 11200 | 14400 |
| Current counterfactual-after-2-files policy | 6 | 8198 | 4200 | 5400 |
...
- The built-in calibration suite matched expected verdicts on 7/7 scenarios in 1.951 seconds.
- The demo project analysis reviewed 7 Python tests across 2 test files and 2 source files in 0.281 seconds with verdict 'reliable'.
