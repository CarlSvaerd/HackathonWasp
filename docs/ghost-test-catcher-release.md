...
```bash
code --install-extension packages/vscode-extension/ghost-test-catcher-0.2.5.vsix --force
```
...
3. Confirm `packages/vscode-extension/ghost-test-catcher-0.2.5.vsix` was rebuilt.
