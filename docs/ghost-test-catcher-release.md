...
```bash
code --install-extension packages/vscode-extension/ghost-test-catcher-0.2.4.vsix --force
```
...
3. Confirm `packages/vscode-extension/ghost-test-catcher-0.2.4.vsix` was rebuilt.
